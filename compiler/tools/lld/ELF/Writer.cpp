...
const uint64_t scratchpad_size = 64*1024;
...
template <class ELFT> void Writer<ELFT>::addStartEndSymbols() {
  ...
  if (OutputSection *Sec = findSection("scratchpad")){
     unsigned size = 0;
     
     std::vector<InputSection *> Sections = getInputSections(Sec);
     ...
     Define("__scratchpad_data_start", "__scratchpad_data_end", Sec);
