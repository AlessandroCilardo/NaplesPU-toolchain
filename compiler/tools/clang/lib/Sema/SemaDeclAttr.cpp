...
static void handleCodeSegAttr(Sema &S, Decl *D, const ParsedAttr &AL) {
 ...
 static void handleScratchpadMem(Sema &S, Decl *D, const ParsedAttr &Attr) {
   unsigned Index = Attr.getAttributeSpellingListIndex();
   SectionAttr *NewAttr = S.mergeSectionAttr(D, Attr.getRange(), "scratchpad", Index);
   if (NewAttr)
     D->addAttr(NewAttr);
 }
...
static void ProcessDeclAttribute(Sema &S, Scope *scope, Decl *D,
  ...
  case ParsedAttr::AT_ScratchpadMem:
    handleScratchpadMem(S, D, AL);
    break;
