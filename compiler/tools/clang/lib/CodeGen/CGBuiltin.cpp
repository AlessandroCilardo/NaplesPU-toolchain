...
Value *MaskToInt16(CGBuilderTy &Builder, Value *Mask)
{
  return Builder.CreateBitCast(Mask, Builder.getInt16Ty());
}

Value *Int16ToMask(CGBuilderTy &Builder, Value *IntVal)
{
  return Builder.CreateBitCast(IntVal,
    llvm::VectorType::get(Builder.getInt1Ty(), 16));
}

Value *CodeGenFunction::EmitNaplesPUBuiltinExpr(unsigned BuiltinID,
                                             const CallExpr *E) {
  ...
  switch (BuiltinID){
  case NaplesPU::BI__builtin_npu_makevectori32:
  case NaplesPU::BI__builtin_npu_makevectorf32:
    return Builder.CreateVectorSplat(16, Ops[0]);
  case NaplesPU::BI__builtin_npu_makevectori64:
  case NaplesPU::BI__builtin_npu_makevectorf64:
    return Builder.CreateVectorSplat(8, Ops[0]);
  }

  llvm::Function *F;
  switch (BuiltinID) {
  case NaplesPU::BI__builtin_npu_shufflei32:
	F = CGM.getIntrinsic(Intrinsic::npu_shufflei32);
	break;
  case NaplesPU::BI__builtin_npu_shufflef32:
	F = CGM.getIntrinsic(Intrinsic::npu_shufflef32);
	break;
  case NaplesPU::BI__builtin_npu_shufflei64:
	F = CGM.getIntrinsic(Intrinsic::npu_shufflei64);
	break;
  case NaplesPU::BI__builtin_npu_shufflef64:
	F = CGM.getIntrinsic(Intrinsic::npu_shufflef64);
	break;
  case NaplesPU::BI__builtin_npu_vector_mixi32:
	F = CGM.getIntrinsic(Intrinsic::npu_vector_mixi32);
	break;
  case NaplesPU::BI__builtin_npu_vector_mixf32:
	F = CGM.getIntrinsic(Intrinsic::npu_vector_mixf32);
	break;
  case NaplesPU::BI__builtin_npu_vector_mixi64:
	F = CGM.getIntrinsic(Intrinsic::npu_vector_mixi64);
	break;
  case NaplesPU::BI__builtin_npu_vector_mixf64:
	F = CGM.getIntrinsic(Intrinsic::npu_vector_mixf64);
	break;
  case NaplesPU::BI__builtin_npu_v16f32tov8f64:
	F = CGM.getIntrinsic(Intrinsic::npu_v16f32tov8f64);
	break;
  case NaplesPU::BI__builtin_npu_v8f64tov16f32:
	F = CGM.getIntrinsic(Intrinsic::npu_v8f64tov16f32);
	break;
  //------ Vector block load operations ------//
  case NaplesPU::BI__builtin_npu_block_loadv16i8:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv16i8);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv16i8_scratchpad:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv16i8_scratchpad);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv16i8_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv16i8_masked);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv16i8_scratchpad_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv16i8_scratchpad_masked);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv8i8:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv8i8);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv8i8_scratchpad:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv8i8_scratchpad);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv8i8_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv8i8_masked);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv8i8_scratchpad_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv8i8_scratchpad_masked);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv16i16:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv16i16);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv16i16_scratchpad:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv16i16_scratchpad);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv16i16_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv16i16_masked);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv16i16_scratchpad_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv16i16_scratchpad_masked);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv8i16:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv8i16);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv8i16_scratchpad:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv8i16_scratchpad);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv8i16_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv8i16_masked);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv8i16_scratchpad_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv8i16_scratchpad_masked);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv16i32_scratchpad:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv16i32_scratchpad);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv16f32_scratchpad:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv16f32_scratchpad);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv16i32_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv16i32_masked);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv16f32_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv16f32_masked);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv16i32_scratchpad_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv16i32_scratchpad_masked);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv16f32_scratchpad_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv16f32_scratchpad_masked);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv8i32:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv8i32);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv8i32_scratchpad:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv8i32_scratchpad);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv8i32_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv8i32_masked);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv8i32_scratchpad_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv8i32_scratchpad_masked);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv8i64_scratchpad:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv8i64_scratchpad);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv8f64_scratchpad:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv8f64_scratchpad);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv8i64_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv8i64_masked);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv8f64_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv8f64_masked);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv8i64_scratchpad_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv8i64_scratchpad_masked);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv8f64_scratchpad_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv8f64_scratchpad_masked);
	break;

  //------ Vector block load operations unsigned ------//
  case NaplesPU::BI__builtin_npu_block_loadv16u8:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv16u8);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv16u8_scratchpad:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv16u8_scratchpad);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv16u8_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv16u8_masked);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv16u8_scratchpad_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv16u8_scratchpad_masked);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv8u8:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv8u8);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv8u8_scratchpad:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv8u8_scratchpad);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv8u8_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv8u8_masked);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv8u8_scratchpad_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv8u8_scratchpad_masked);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv16u16:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv16u16);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv16u16_scratchpad:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv16u16_scratchpad);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv16u16_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv16u16_masked);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv16u16_scratchpad_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv16u16_scratchpad_masked);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv8u16:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv8u16);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv8u16_scratchpad:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv8u16_scratchpad);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv8u16_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv8u16_masked);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv8u16_scratchpad_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv8u16_scratchpad_masked);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv8u32:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv8u32);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv8u32_scratchpad:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv8u32_scratchpad);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv8u32_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv8u32_masked);
	break;
  case NaplesPU::BI__builtin_npu_block_loadv8u32_scratchpad_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_block_loadv8u32_scratchpad_masked);
	break;
  
  //------ Vector gather load operations ------//
  case NaplesPU::BI__builtin_npu_gather_loadi32_scratchpad:
	F = CGM.getIntrinsic(Intrinsic::npu_gather_loadi32_scratchpad);
	break;
  case NaplesPU::BI__builtin_npu_gather_loadf32_scratchpad:
	F = CGM.getIntrinsic(Intrinsic::npu_gather_loadf32_scratchpad);
	break;
  case NaplesPU::BI__builtin_npu_gather_loadi32_scratchpad_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_gather_loadi32_scratchpad_masked);
	break;
  case NaplesPU::BI__builtin_npu_gather_loadf32_scratchpad_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_gather_loadf32_scratchpad_masked);
	break;
  case NaplesPU::BI__builtin_npu_gather_loadi64_scratchpad:
	F = CGM.getIntrinsic(Intrinsic::npu_gather_loadi64_scratchpad);
	break;
  case NaplesPU::BI__builtin_npu_gather_loadf64_scratchpad:
	F = CGM.getIntrinsic(Intrinsic::npu_gather_loadf64_scratchpad);
	break;
  case NaplesPU::BI__builtin_npu_gather_loadi64_scratchpad_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_gather_loadi64_scratchpad_masked);
	break;
  case NaplesPU::BI__builtin_npu_gather_loadf64_scratchpad_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_gather_loadf64_scratchpad_masked);
	break;
  //------ Vector block store operations ------//
  case NaplesPU::BI__builtin_npu_block_storev16i8:
	F = CGM.getIntrinsic(Intrinsic::npu_block_storev16i8);
	break;
  case NaplesPU::BI__builtin_npu_block_storev16i8_scratchpad:
	F = CGM.getIntrinsic(Intrinsic::npu_block_storev16i8_scratchpad);
	break;
  case NaplesPU::BI__builtin_npu_block_storev16i8_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_block_storev16i8_masked);
	break;
  case NaplesPU::BI__builtin_npu_block_storev16i8_scratchpad_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_block_storev16i8_scratchpad_masked);
	break;
  case NaplesPU::BI__builtin_npu_block_storev8i8:
	F = CGM.getIntrinsic(Intrinsic::npu_block_storev8i8);
	break;	
  case NaplesPU::BI__builtin_npu_block_storev8i8_scratchpad:
	F = CGM.getIntrinsic(Intrinsic::npu_block_storev8i8_scratchpad);
	break;
  case NaplesPU::BI__builtin_npu_block_storev8i8_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_block_storev8i8_masked);
	break;
  case NaplesPU::BI__builtin_npu_block_storev8i8_scratchpad_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_block_storev8i8_scratchpad_masked);
	break;
  case NaplesPU::BI__builtin_npu_block_storev16i16:
	F = CGM.getIntrinsic(Intrinsic::npu_block_storev16i16);
	break;
  case NaplesPU::BI__builtin_npu_block_storev16i16_scratchpad:
	F = CGM.getIntrinsic(Intrinsic::npu_block_storev16i16_scratchpad);
	break;
  case NaplesPU::BI__builtin_npu_block_storev16i16_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_block_storev16i16_masked);
	break;
  case NaplesPU::BI__builtin_npu_block_storev16i16_scratchpad_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_block_storev16i16_scratchpad_masked);
	break;
  case NaplesPU::BI__builtin_npu_block_storev8i16:
	F = CGM.getIntrinsic(Intrinsic::npu_block_storev8i16);
	break;	
  case NaplesPU::BI__builtin_npu_block_storev8i16_scratchpad:
	F = CGM.getIntrinsic(Intrinsic::npu_block_storev8i16_scratchpad);
	break;
  case NaplesPU::BI__builtin_npu_block_storev8i16_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_block_storev8i16_masked);
	break;
  case NaplesPU::BI__builtin_npu_block_storev8i16_scratchpad_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_block_storev8i16_scratchpad_masked);
	break;
  case NaplesPU::BI__builtin_npu_block_storev16i32_scratchpad:
	F = CGM.getIntrinsic(Intrinsic::npu_block_storev16i32_scratchpad);
	break;
  case NaplesPU::BI__builtin_npu_block_storev16f32_scratchpad:
	F = CGM.getIntrinsic(Intrinsic::npu_block_storev16f32_scratchpad);
	break;
  case NaplesPU::BI__builtin_npu_block_storev16i32_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_block_storev16i32_masked);
	break;
  case NaplesPU::BI__builtin_npu_block_storev16f32_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_block_storev16f32_masked);
	break;
  case NaplesPU::BI__builtin_npu_block_storev16i32_scratchpad_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_block_storev16i32_scratchpad_masked);
	break;
  case NaplesPU::BI__builtin_npu_block_storev16f32_scratchpad_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_block_storev16f32_scratchpad_masked);
	break;
  case NaplesPU::BI__builtin_npu_block_storev8i32:
	F = CGM.getIntrinsic(Intrinsic::npu_block_storev8i32);
	break;
  case NaplesPU::BI__builtin_npu_block_storev8i32_scratchpad:
	F = CGM.getIntrinsic(Intrinsic::npu_block_storev8i32_scratchpad);
	break;
  case NaplesPU::BI__builtin_npu_block_storev8i32_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_block_storev8i32_masked);
	break;
  case NaplesPU::BI__builtin_npu_block_storev8i32_scratchpad_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_block_storev8i32_scratchpad_masked);
	break;
  case NaplesPU::BI__builtin_npu_block_storev8i64_scratchpad:
	F = CGM.getIntrinsic(Intrinsic::npu_block_storev8i64_scratchpad);
	break;
  case NaplesPU::BI__builtin_npu_block_storev8f64_scratchpad:
	F = CGM.getIntrinsic(Intrinsic::npu_block_storev8f64_scratchpad);
	break;
  case NaplesPU::BI__builtin_npu_block_storev8i64_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_block_storev8i64_masked);
	break;
  case NaplesPU::BI__builtin_npu_block_storev8f64_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_block_storev8f64_masked);
	break;
  case NaplesPU::BI__builtin_npu_block_storev8i64_scratchpad_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_block_storev8i64_scratchpad_masked);
	break;
  case NaplesPU::BI__builtin_npu_block_storev8f64_scratchpad_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_block_storev8f64_scratchpad_masked);
	break;
  //------ Vector scatter store operations ------//
  case NaplesPU::BI__builtin_npu_scatter_storei32_scratchpad:
	F = CGM.getIntrinsic(Intrinsic::npu_scatter_storei32_scratchpad);
	break;
  case NaplesPU::BI__builtin_npu_scatter_storef32_scratchpad:
	F = CGM.getIntrinsic(Intrinsic::npu_scatter_storef32_scratchpad);
	break;
  case NaplesPU::BI__builtin_npu_scatter_storei32_scratchpad_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_scatter_storei32_scratchpad_masked);
	break;
  case NaplesPU::BI__builtin_npu_scatter_storef32_scratchpad_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_scatter_storef32_scratchpad_masked);
	break;
  case NaplesPU::BI__builtin_npu_scatter_storei64_scratchpad:
	F = CGM.getIntrinsic(Intrinsic::npu_scatter_storei64_scratchpad);
	break;
  case NaplesPU::BI__builtin_npu_scatter_storef64_scratchpad:
	F = CGM.getIntrinsic(Intrinsic::npu_scatter_storef64_scratchpad);
	break;
  case NaplesPU::BI__builtin_npu_scatter_storei64_scratchpad_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_scatter_storei64_scratchpad_masked);
	break;
  case NaplesPU::BI__builtin_npu_scatter_storef64_scratchpad_masked:
	F = CGM.getIntrinsic(Intrinsic::npu_scatter_storef64_scratchpad_masked);
	break;

  // Vector comparisions 32bit
  case NaplesPU::BI__builtin_npu_mask_cmpi32_ugt:
	F = CGM.getIntrinsic(Intrinsic::npu_mask_cmpi32_ugt);
	break;
  case NaplesPU::BI__builtin_npu_mask_cmpi32_uge:
	F = CGM.getIntrinsic(Intrinsic::npu_mask_cmpi32_uge);
	break;
  case NaplesPU::BI__builtin_npu_mask_cmpi32_ult:
	F = CGM.getIntrinsic(Intrinsic::npu_mask_cmpi32_ult);
	break;
  case NaplesPU::BI__builtin_npu_mask_cmpi32_ule:
	F = CGM.getIntrinsic(Intrinsic::npu_mask_cmpi32_ule);
	break;
  case NaplesPU::BI__builtin_npu_mask_cmpi32_sgt:
	F = CGM.getIntrinsic(Intrinsic::npu_mask_cmpi32_sgt);
	break;
  case NaplesPU::BI__builtin_npu_mask_cmpi32_sge:
	F = CGM.getIntrinsic(Intrinsic::npu_mask_cmpi32_sge);
	break;
  case NaplesPU::BI__builtin_npu_mask_cmpi32_slt:
	F = CGM.getIntrinsic(Intrinsic::npu_mask_cmpi32_slt);
	break;
  case NaplesPU::BI__builtin_npu_mask_cmpi32_sle:
	F = CGM.getIntrinsic(Intrinsic::npu_mask_cmpi32_sle);
	break;
  case NaplesPU::BI__builtin_npu_mask_cmpi32_eq:
	F = CGM.getIntrinsic(Intrinsic::npu_mask_cmpi32_eq);
	break;
  case NaplesPU::BI__builtin_npu_mask_cmpi32_ne:
	F = CGM.getIntrinsic(Intrinsic::npu_mask_cmpi32_ne);
	break;
  case NaplesPU::BI__builtin_npu_mask_cmpf32_gt:
	F = CGM.getIntrinsic(Intrinsic::npu_mask_cmpf32_gt);
	break;
  case NaplesPU::BI__builtin_npu_mask_cmpf32_ge:
	F = CGM.getIntrinsic(Intrinsic::npu_mask_cmpf32_ge);
	break;
  case NaplesPU::BI__builtin_npu_mask_cmpf32_lt:
	F = CGM.getIntrinsic(Intrinsic::npu_mask_cmpf32_lt);
	break;
  case NaplesPU::BI__builtin_npu_mask_cmpf32_le:
	F = CGM.getIntrinsic(Intrinsic::npu_mask_cmpf32_le);
	break;
  case NaplesPU::BI__builtin_npu_mask_cmpf32_eq:
	F = CGM.getIntrinsic(Intrinsic::npu_mask_cmpf32_eq);
	break;
  case NaplesPU::BI__builtin_npu_mask_cmpf32_ne:
	F = CGM.getIntrinsic(Intrinsic::npu_mask_cmpf32_ne);
	break;

  // Vector comparisions 64bit
  case NaplesPU::BI__builtin_npu_mask_cmpi64_ugt:
	F = CGM.getIntrinsic(Intrinsic::npu_mask_cmpi64_ugt);
	break;
  case NaplesPU::BI__builtin_npu_mask_cmpi64_uge:
	F = CGM.getIntrinsic(Intrinsic::npu_mask_cmpi64_uge);
	break;
  case NaplesPU::BI__builtin_npu_mask_cmpi64_ult:
	F = CGM.getIntrinsic(Intrinsic::npu_mask_cmpi64_ult);
	break;
  case NaplesPU::BI__builtin_npu_mask_cmpi64_ule:
	F = CGM.getIntrinsic(Intrinsic::npu_mask_cmpi64_ule);
	break;
  case NaplesPU::BI__builtin_npu_mask_cmpi64_sgt:
	F = CGM.getIntrinsic(Intrinsic::npu_mask_cmpi64_sgt);
	break;
  case NaplesPU::BI__builtin_npu_mask_cmpi64_sge:
	F = CGM.getIntrinsic(Intrinsic::npu_mask_cmpi64_sge);
	break;
  case NaplesPU::BI__builtin_npu_mask_cmpi64_slt:
	F = CGM.getIntrinsic(Intrinsic::npu_mask_cmpi64_slt);
	break;
  case NaplesPU::BI__builtin_npu_mask_cmpi64_sle:
	F = CGM.getIntrinsic(Intrinsic::npu_mask_cmpi64_sle);
	break;
  case NaplesPU::BI__builtin_npu_mask_cmpi64_eq:
	F = CGM.getIntrinsic(Intrinsic::npu_mask_cmpi64_eq);
	break;
  case NaplesPU::BI__builtin_npu_mask_cmpi64_ne:
	F = CGM.getIntrinsic(Intrinsic::npu_mask_cmpi64_ne);
	break;
  case NaplesPU::BI__builtin_npu_mask_cmpf64_gt:
	F = CGM.getIntrinsic(Intrinsic::npu_mask_cmpf64_gt);
	break;
  case NaplesPU::BI__builtin_npu_mask_cmpf64_ge:
	F = CGM.getIntrinsic(Intrinsic::npu_mask_cmpf64_ge);
	break;
  case NaplesPU::BI__builtin_npu_mask_cmpf64_lt:
	F = CGM.getIntrinsic(Intrinsic::npu_mask_cmpf64_lt);
	break;
  case NaplesPU::BI__builtin_npu_mask_cmpf64_le:
	F = CGM.getIntrinsic(Intrinsic::npu_mask_cmpf64_le);
	break;
  case NaplesPU::BI__builtin_npu_mask_cmpf64_eq:
	F = CGM.getIntrinsic(Intrinsic::npu_mask_cmpf64_eq);
	break;
  case NaplesPU::BI__builtin_npu_mask_cmpf64_ne:
	F = CGM.getIntrinsic(Intrinsic::npu_mask_cmpf64_ne);
	break;
  case NaplesPU::BI__builtin_npu_read_mask_reg:
    F = CGM.getIntrinsic(Intrinsic::npu_read_mask_reg);
	break;
  case NaplesPU::BI__builtin_npu_write_mask_reg:
    F = CGM.getIntrinsic(Intrinsic::npu_write_mask_reg);
	break;
  case NaplesPU::BI__builtin_npu_write_mask_regv16i32:
    F = CGM.getIntrinsic(Intrinsic::npu_write_mask_regv16i32);
	break;
  case NaplesPU::BI__builtin_npu_write_mask_regv8i64:
    F = CGM.getIntrinsic(Intrinsic::npu_write_mask_regv8i64);
	break;
  case NaplesPU::BI__builtin_npu_read_control_reg:
    F = CGM.getIntrinsic(Intrinsic::npu_read_control_reg);
	break;
  case NaplesPU::BI__builtin_npu_write_control_reg:
    F = CGM.getIntrinsic(Intrinsic::npu_write_control_reg);
	break;
  case NaplesPU::BI__builtin_npu_barrier:
    F = CGM.getIntrinsic(Intrinsic::npu_barrier);
	break;
  case NaplesPU::BI__builtin_npu_flush:
    F = CGM.getIntrinsic(Intrinsic::npu_flush);
	break;
  case NaplesPU::BI__builtin_npu_dcacheinv:
    F = CGM.getIntrinsic(Intrinsic::npu_dcacheinv);
	break;
  // Cross Product
  case NaplesPU::BI__builtin_npu_crossprodv16i32:
	...
	break;
  // Create Mask
  case NaplesPU::BI__builtin_npu_createmaskv16i32:
    F = CGM.getIntrinsic(Intrinsic::npu_createmaskv16i32);
	break;
  case NaplesPU::BI__builtin_npu_createmaskv8i64:
    F = CGM.getIntrinsic(Intrinsic::npu_createmaskv8i64);
	break;
  case NaplesPU::BI__builtin_npu_clzi32:
    F = CGM.getIntrinsic(Intrinsic::npu_clzi32);
	break;
  case NaplesPU::BI__builtin_npu_clzi64:
    F = CGM.getIntrinsic(Intrinsic::npu_clzi64);
	break;
  case NaplesPU::BI__builtin_npu_clzv16i32:
    F = CGM.getIntrinsic(Intrinsic::npu_clzv16i32);
	break;
  case NaplesPU::BI__builtin_npu_clzv8i64:
    F = CGM.getIntrinsic(Intrinsic::npu_clzv8i64);
	break;
  case NaplesPU::BI__builtin_npu_ctzi32:
    F = CGM.getIntrinsic(Intrinsic::npu_ctzi32);
	break;
  case NaplesPU::BI__builtin_npu_ctzi64:
    F = CGM.getIntrinsic(Intrinsic::npu_ctzi64);
	break;
  case NaplesPU::BI__builtin_npu_ctzv16i32:
    F = CGM.getIntrinsic(Intrinsic::npu_ctzv16i32);
	break;
  case NaplesPU::BI__builtin_npu_ctzv8i64:
